...
@section('route.new',route('permission.create'))
@section('label.new','Toestemming')
...
<div class="table-vue" data-src="{{ $vtable['src'] }}" >
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover table-condensed" >
            <thead> 
                <tr>
                    <th class="collapse" @click="table.sorting.doSort('id')" v-bind:class="table.sorting.sorting.id" sortable >#</th>
