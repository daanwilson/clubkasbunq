...
@section('title','Geld doelen')
@section('route.new',route('moneypurpose.create'))
@section('label.new','Doel')
        ...
        <table class="table table-striped table-hover table-condensed" >
            <thead> 
                <tr>
                    ...
                    <th @click="table.sorting.doSort('purpose_name')" v-bind:class="table.sorting.sorting.purpose_name" sortable >Doel</th>
